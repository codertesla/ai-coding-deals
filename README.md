...
| **CodeBuddy**（Tencent, regional）✅ *verified* | New sign-ups (**WeChat login**) receive **2,000 credits**; completing onboarding tasks grants additional credits for a **total of up to 3,600 credits** (valid **1 month**) — roughly equivalent to one free month of the Standard plan (**¥99/mo**); plus **HY3 model free for all users** (0 credits, **2026-07-06 through 2026-07-22**) | Verified July 2026 on a new account: trial-tier status, but first-month credit allowance rivals the Standard plan; CodeBuddy and WorkBuddy are now the same product |
...
| **CodeBuddy**（Tencent, regional） | Trial: **Free (500 credits/month baseline)** (rate-limited chat)<br>Standard: **¥99/month** (2,000 credits)<br>Flagship: ¥198/month<br>Exclusive: ¥316/month | ✅ **New sign-ups (WeChat login) receive 2,000 credits; completing onboarding tasks grants up to 3,600 credits total** (valid 1 month — roughly one free month of Standard); trial tier also includes 500 credits/month baseline;<br>⏳ **Limited-Time Promo: HY3 model free for all users (0 credits) through 2026-07-22** | Regional developers operating primarily within the Tencent Cloud ecosystem | [codebuddy.cn](https://www.codebuddy.cn/pricing/) |
...
| **CodeBuddy**（Tencent, regional） | **HY3 model free for all users** — **0 credits** consumed; HY3 Agent capabilities significantly upgraded | **2026-07-22** | CodeBuddy and WorkBuddy are now the same product; new sign-ups also receive up to **3,600 credits** (see Top Deals above) — details at [codebuddy.cn](https://www.codebuddy.cn/) |
