...
Curated by recommendation priority (higher rows first). Expired, paused-signup, or niche-only offers were removed from this table — they remain in the category sections below. (Refreshed July 2026 — confirm on the official vendor page before purchasing.)

| Tool | The deal | Why it's worth it |
|------|----------|-------------------|
| **Cursor** ✅ *verified* | **50% off your first month** for new accounts via any referral link — Pro for **$10** (first month), with proportional discounts on higher tiers. Referral links have usage limits; search for a fresh link (e.g., search "Cursor referral link"). **Alipay accepted** — remember to cancel auto-renew if you do not plan to continue. | Leading Agentic IDE; verified June 2026 — the lowest-cost entry to full Pro features |
| **CodeBuddy / WorkBuddy**（Tencent, regional）✅ *verified* | Sign up via [WorkBuddy invite link](https://www.workbuddy.cn/events/invite?inviteCode=fmfw2whmh) (**WeChat login**): invitees receive a **2,000-credit signup bonus** (valid **1 month**); completing onboarding tasks grants additional credits for a **total of up to 3,600 credits** — roughly equivalent to one free month of the Standard plan (**¥99/mo**); **on first paid purchase, both parties receive 500 credits** (invitee bonus once only, valid **6 months**), and invitees still qualify for other promos; plus **HY3 model free for all users** (0 credits, **2026-07-06 through 2026-07-22**); now includes flagship **Kimi K3** (~**1.62×** credit multiplier) | Strongest regional new-user credit pack — roughly one free Standard month; **prefer this first if you want to try Kimi K3 for free** — first-month credits are usually enough for a solid trial |
| **Tencent Cloud AI Model Square** ✅ *verified* | New users can visit the [Model Square](https://curl.qcloud.com/PN0cvBnI) and click "**New User Benefits Free Experience**" (top-right corner) to claim — **all language models** and **all multimodal understanding models** each receive **1M free trial tokens**, valid for **90 days** from claim (incl. **HY3**, GLM-5.2, DeepSeek V4 Pro, Kimi K2.7 Code, etc.); Hunyuan **HY3** also offers a dedicated **Hy Token Plan** starting at **¥28/month for 35M tokens** | Best low/zero-cost API base for regional BYOK clients — one key covers multiple flagship models |
| **Freebuff** | **100% free** ad-supported coding agent (CLI / Web / Chat) at [freebuff.com](https://freebuff.com/) — requires no API key or subscription; [Web referral link](https://freebuff.com/web/?ref=ref-b3046190-1d77-44c1-915c-b71b4f36ae5e) | Genuinely $0 — simplest zero-budget path to try a CLI / Web agent |
| **OpenAI Codex** | **Included in ChatGPT Free** — accessible via Web, CLI, and **desktop applications (macOS/Windows)** with no credit card required | Broadest zero-cost entry; any ChatGPT Free account can start immediately |
| **Google Antigravity / Gemini** | Generous **free tier**; AI Pro subscription available at **$19.99/month** | Generous free tier; lowest-friction way to try multi-agent / fast Gemini workflows |
| **OpenCode** ✅ *verified* | **$5 free credit** for both parties when signing up via [referral link](https://opencode.ai/go?ref=J9E8732NMP) | Highly cost-effective when paired with cheap regional models (Qwen, DeepSeek, GLM, Kimi) |
| **Grok / SuperGrok**（xAI）✅ *verified* | **7-day SuperGrok free trial** via [grok.com/plans](https://grok.com/plans) — unlocks **Grok 4.5** and **Grok Build** (xAI terminal coding agent) at full paid limits; **credit card required**; cancel before the trial ends or you are billed **$30/month**. Likely limited to accounts that have **never subscribed** before; promo end date unclear | One free week of frontier model + terminal agent — cancel before the trial ends |
| **Kimi**（Moonshot） | **Limited-time free membership lottery** via [invite link](https://kimi-bot.com/activities/zh-cn/viral-referral/share?scenario=invite&from=share_poster&invitation_code=ZCDJXZ) — prizes of **3 / 7 / 15 / 30 / up to 365 days** (minimum 3 days); flagship **Kimi K3** released **2026-07-17**, ranking **TOP 3** on multiple benchmarks; paid plans at [membership pricing](https://www.kimi.com/membership/pricing?from=kfc_membership_upgrade_price&track_id=fcbd4630-4439-498a-b934-d6cee41da4f1) (CN tiers from Andante **¥49/mo**, incl. Kimi Code / Agent) | Lottery odds are uncertain; **for a more reliable free K3 trial, prefer WorkBuddy first** (first-month credits usually suffice) |
| **Cline (ClinePass)** | **$1.99/month launch promo** (standard **$9.99/month**) when signing up via `npm i -g cline` — now includes flagship **Kimi K3** at official **~5× discounted access**; also bundled GLM-5.2, Kimi K2.7 Code, DeepSeek V4, Qwen3.7, MiniMax, MiMo, and more; available on Cline CLI & IDE | One of the lower-cost paid paths to **Kimi K3** (especially while Kimi capacity is constrained); regional new users wanting a free trial should prefer WorkBuddy first; promo end date TBD — verify at [cline.bot](https://cline.bot) or [x.com/cline](https://x.com/cline) |
...
| **CodeBuddy / WorkBuddy**（Tencent, regional） | Trial: **Free (500 credits/month baseline)** (rate-limited chat)<br>Standard: **¥99/month** (2,000 credits)<br>Flagship: ¥198/month<br>Exclusive: ¥316/month | ✅ Via [WorkBuddy invite link](https://www.workbuddy.cn/events/invite?inviteCode=fmfw2whmh): invitees get **2,000 signup credits** (valid 1 month) + onboarding up to **3,600 total**; **first paid purchase: both parties get 500 credits** (invitee once only, valid 6 months); trial tier also includes 500 credits/month baseline; now includes flagship **Kimi K3** (~**1.62×** credit multiplier);<br>⏳ **Limited-Time Promo: HY3 model free for all users (0 credits) through 2026-07-22** | Regional developers in the Tencent Cloud ecosystem; **new users wanting a free Kimi K3 trial should prefer this first — first-month credits are usually enough** | [workbuddy.cn](https://www.workbuddy.cn/events/invite?inviteCode=fmfw2whmh) / [codebuddy.cn](https://www.codebuddy.cn/pricing/) |
...
| **Cline** | **Free and open-source** (supports BYOK or local models)<br>**ClinePass: $9.99/mo** — now includes **Kimi K3** at official **~5× discounted access**, plus GLM-5.2, Kimi K2.7 Code, DeepSeek V4, Qwen3.7, MiniMax, MiMo, and more; works on IDE extension & CLI | ⏳ **ClinePass launch promo: $1.99/mo** when signing up via `npm i -g cline` (end date TBD — verify at [cline.bot](https://cline.bot) / [x.com/cline](https://x.com/cline)); BYOK/local mode remains $0 | Developers seeking a highly autonomous VS Code agent; one of the lower fixed-cost paid paths to **Kimi K3** (regional new users wanting a free trial should prefer WorkBuddy) | [cline.bot](https://cline.bot) |
...
| **Grok Build**（xAI） | Free tier of Grok chat (rate-limited)<br>**SuperGrok: $30/mo**<br>SuperGrok Heavy: higher tier | ✅ **7-day SuperGrok free trial** at [grok.com/plans](https://grok.com/plans) — includes **Grok 4.5** and Grok Build at paid limits; requires a credit card; **cancel before trial ends** to avoid $30/mo billing. Appears aimed at **never-subscribed** accounts; promo end date TBD | Terminal coding agent powered by Grok 4.5; evaluate frontier xAI models without an immediate subscription | [grok.com/plans](https://grok.com/plans) |
| **Kimi**（Moonshot / Kimi Code） | Adagio: **Free**<br>Andante: **¥49/mo**<br>Moderato: ¥99/mo<br>Allegretto: ¥199/mo<br>Allegro: ¥699/mo<br>(annual billing cheaper; shared credit pool for Kimi Code / Agent)<br>*Intl tiers also available (e.g. Moderato $19/mo)* | ⏳ **Limited-time free membership lottery** via [invite link](https://kimi-bot.com/activities/zh-cn/viral-referral/share?scenario=invite&from=share_poster&invitation_code=ZCDJXZ) — **3 / 7 / 15 / 30 / up to 365 days** (min. 3 days); flagship **Kimi K3** (**2026-07-17**, **TOP 3** on multiple benchmarks) live on Web / Code / API | Developers wanting membership access to Kimi Code / Agent, or evaluating the latest **Kimi K3** for coding & agentic work; **for a free K3 trial, prefer WorkBuddy first** (first-month credits usually suffice) | [kimi.com/membership/pricing](https://www.kimi.com/membership/pricing?from=kfc_membership_upgrade_price&track_id=fcbd4630-4439-498a-b934-d6cee41da4f1) |
...
| **Cline** | Open-source version is free (BYOK)<br>**ClinePass: $9.99/mo** — now includes **Kimi K3** at official **~5× discounted access**, plus GLM-5.2, Kimi K2.7 Code, DeepSeek V4, Qwen3.7, MiniMax, MiMo, and more; CLI via `npm i -g cline` | ⏳ **ClinePass launch promo: $1.99/mo** when signing up via CLI (end date TBD — verify at [cline.bot](https://cline.bot) / [x.com/cline](https://x.com/cline)) | One of the lower-cost paid paths to **Kimi K3**; regional new users wanting a free trial should prefer WorkBuddy; available on Cline CLI & IDE | [cline.bot](https://cline.bot) |
...
|------|-------|---------|-------|
| **Cline (ClinePass)** | **$1.99/month launch promo** (standard $9.99/month) via `npm i -g cline`; now includes **Kimi K3** at official **~5× discounted access** | **TBD** (new product launch; end date not yet announced) | Also includes GLM-5.2, Kimi K2.7 Code, DeepSeek V4, Qwen3.7, MiniMax, MiMo, and more; one of the lower-cost paid paths to K3 (regional new users wanting a free trial should prefer WorkBuddy) — see [x.com/cline](https://x.com/cline); verify terms at [cline.bot](https://cline.bot) |
| **CodeBuddy / WorkBuddy**（Tencent, regional） | **HY3 model free for all users** — **0 credits** consumed; HY3 Agent capabilities significantly upgraded; now includes flagship **Kimi K3** (~**1.62×** credit multiplier) | **2026-07-22** (HY3 free window); Kimi K3 is generally available | Same product; invitees via [WorkBuddy invite link](https://www.workbuddy.cn/events/invite?inviteCode=fmfw2whmh) get **2,000 signup credits** (1 month) + up to **3,600** with onboarding, and **500 credits on first paid purchase** (see Featured Deals) — **prefer this first for a free Kimi trial; first-month credits are usually enough** — also [codebuddy.cn](https://www.codebuddy.cn/) |
...
| **Grok / SuperGrok**（xAI） | **7-day SuperGrok free trial** — Grok 4.5 + Grok Build at paid limits; start at [grok.com/plans](https://grok.com/plans) | **TBD** (promo window end date not announced; verified active July 2026) | Credit card required; cancel before the trial ends or **$30/month** auto-renews. Likely limited to accounts that have **never subscribed**; existing/past subscribers may not see the offer |
| **Kimi**（Moonshot） | **Free membership lottery** via [invite link](https://kimi-bot.com/activities/zh-cn/viral-referral/share?scenario=invite&from=share_poster&invitation_code=ZCDJXZ) — win **3 / 7 / 15 / 30 / up to 365 days** of membership (minimum 3 days); flagship **Kimi K3** released **2026-07-17** (**TOP 3** on multiple benchmarks) | **TBD** (time-limited; confirm end date on the activity page) | Paid plans at [membership pricing](https://www.kimi.com/membership/pricing?from=kfc_membership_upgrade_price&track_id=fcbd4630-4439-498a-b934-d6cee41da4f1): Adagio free / Andante ¥49 / Moderato ¥99 / Allegretto ¥199 / Allegro ¥699 (annual cheaper); includes shared Kimi Code & Agent credits; **for a more reliable free K3 trial, prefer WorkBuddy first** |
...
| **Regional Developer / Maximum Cost Efficiency** | **WorkBuddy** (invite signup credits) / Tencent Cloud AI Model Square (free trial packs) / ClinePass ($9.99/mo, promo $1.99) / OpenCode / Aider + regional APIs (Qwen, DeepSeek, GLM, Kimi) | **Prefer WorkBuddy first for a free Kimi K3 trial** — first-month credits (up to ~3,600) are usually enough; Model Square new users can claim **1M free tokens per language/multimodal model** (**90-day** validity); ClinePass now includes **Kimi K3** at **~5× discounted access** plus 10+ open-weight models; BYOK clients with regional APIs enable pay-as-you-go billing and near-zero running costs |
