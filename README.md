...
| **CodeBuddy**（Tencent, regional）✅ | **HY3 model free for all users** — **0 credits** consumed during the promo (**2026-07-06 through 2026-07-22**); HY3 features significantly upgraded Agent capabilities | Zero-cost way to evaluate Tencent's latest Hunyuan **HY3** Agent model inside CodeBuddy (formerly marketed as WorkBuddy) |
...
| **CodeBuddy**（Tencent, regional） | **HY3 model free for all users** — **0 credits** consumed; HY3 Agent capabilities significantly upgraded | **2026-07-22** | CodeBuddy and WorkBuddy are now the same product; details at [codebuddy.cn](https://www.codebuddy.cn/) |
