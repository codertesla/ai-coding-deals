...
|------|-------------------|------------------|----------|------|
| **GitHub Copilot** | Free (limited) · Pro: **$10/mo** · Pro+: $39/mo · Business: $19/user · Max: $100/mo | **Cheapest entry**; unlimited inline completions stay free; free for verified students/teachers & many OSS maintainers | GitHub-centric teams; safest enterprise pick | [github.com/features/copilot](https://github.com/features/copilot) |
...
| **Claude Code** | Via Claude Pro **$17/mo (annual)–$20/mo** · Max: $100–$200/mo | Annual billing ~15% off | Deepest reasoning; large refactors; 1M context | [claude.com/claude-code](https://www.claude.com/product/claude-code) |
