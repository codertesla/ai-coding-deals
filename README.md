...
|------|-------------------|--------------------------|----------|------|
| **Cursor** | Hobby: free (limited) · Pro: **$20/mo ($20 usage)** · Pro+: **$60 ($70 usage)** · Ultra: $200 ($400 usage) · Teams Standard $40/seat (annual $32) · Premium $120/seat | ✅ **New accounts: 50% off first month via any referral link** (Pro ≈ $10 first month, higher tiers too). Links have limited uses — search for a fresh one. · Annual billing ~20% off · usage = $ at API rates, overage pay-as-you-go | Power users; multi-model + parallel agents; largest community | [cursor.com](https://cursor.com) |
