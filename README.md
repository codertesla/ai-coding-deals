...
| **CodeBuddy / WorkBuddy**（Tencent, regional） | Trial: **Free (500 credits/month baseline)** (rate-limited chat)<br>Standard: **¥99/month** (2,000 credits)<br>Flagship: ¥198/month<br>Exclusive: ¥316/month | ✅ Via [WorkBuddy invite link](https://www.workbuddy.cn/events/invite?inviteCode=fmfw2whmh): invitees get **2,000 signup credits** (valid 1 month) + onboarding up to **3,600 total**; **first paid purchase: both parties get 500 credits** (invitee once only, valid 6 months); trial tier also includes 500 credits/month baseline;<br>⏳ **Limited-Time Promo: HY3 model free for all users (0 credits) through 2026-07-22** | Regional developers operating primarily within the Tencent Cloud ecosystem | [workbuddy.cn](https://www.workbuddy.cn/events/invite?inviteCode=fmfw2whmh) / [codebuddy.cn](https://www.codebuddy.cn/pricing/) |
...
| **Cline** | Open-source version is free (BYOK)<br>**ClinePass: $9.99/mo** — now includes **Kimi K3** at official **~5× discounted access**, plus GLM-5.2, Kimi K2.7 Code, DeepSeek V4, Qwen3.7, MiniMax, MiMo, and more; CLI via `npm i -g cline` | ⏳ **ClinePass launch promo: $1.99/mo** when signing up via CLI (end date TBD — verify at [cline.bot](https://cline.bot) / [x.com/cline](https://x.com/cline)) | Officially one of the most affordable ways to access **Kimi K3** today; available on Cline CLI & IDE | [cline.bot](https://cline.bot) |
...
|------|-------|---------|-------|
| **Cline (ClinePass)** | **$1.99/month launch promo** (standard $9.99/month) via `npm i -g cline`; now includes **Kimi K3** at official **~5× discounted access** | **TBD** (new product launch; end date not yet announced) | Also includes GLM-5.2, Kimi K2.7 Code, DeepSeek V4, Qwen3.7, MiniMax, MiMo, and more; officially positioned as currently one of the most affordable ways to access K3 — see [x.com/cline](https://x.com/cline); verify terms at [cline.bot](https://cline.bot) |
| **CodeBuddy / WorkBuddy**（Tencent, regional） | **HY3 model free for all users** — **0 credits** consumed; HY3 Agent capabilities significantly upgraded | **2026-07-22** | Same product; invitees via [WorkBuddy invite link](https://www.workbuddy.cn/events/invite?inviteCode=fmfw2whmh) get **2,000 signup credits** (1 month) + up to **3,600** with onboarding, and **500 credits on first paid purchase** (see Featured Deals) — also [codebuddy.cn](https://www.codebuddy.cn/) |
...
| **Regional Developer / Maximum Cost Efficiency** | Tencent Cloud AI Model Square (free trial packs) / ClinePass ($9.99/mo, promo $1.99) / OpenCode / Aider + regional APIs (Qwen, DeepSeek, GLM, Kimi) | Model Square new users can claim **1M free tokens per language/multimodal model** (**90-day** validity); ClinePass now includes **Kimi K3** at **~5× discounted access** plus 10+ open-weight models; BYOK clients with regional APIs enable pay-as-you-go billing and near-zero running costs |
