...
AI 编程工具的定价变化**极快**。本仓库专门收集 **免费额度、折扣、邀请返利,以及每个工具最便宜的用法**,帮你不花冤枉钱。由社区共同维护,对照官网核实。
...
最值得马上拿下的高性价比选项。(2026-06 核实,付费前请再确认官网。)

| 工具 | 优惠 | 为什么值 |
|------|------|----------|
| **Cursor** ✅ *已验证* | 新账号经邀请链接 **首月 5 折**——Pro 首月 **$10**,更高档位也有对应折扣 | 2026-06 用全新账号实测有效;体验 Pro 最便宜的方式 |
...
|------|----------------|------------------|------|------|
| **Cursor** | Hobby 免费 · Pro **$20/月** · Ultra $200/月 · Teams $32/席/月(年付) | ✅ **新账号经邀请链接首月 5 折**(Pro 首月约 $10,更高档位也有折扣)· 年付约 8 折 | 重度用户;多模型 + 并行 Agent;社区最大 | [cursor.com](https://cursor.com) |
...
| **Zed** | 编辑器免费 · Pro 低价档 | 核心编辑器免费 | 追求速度、本地优先、隐私友好 | [zed.dev](https://zed.dev) |
...
|------|----------------|--------------|------|------|
| **GitHub Copilot** | 免费(有限)· Pro **$10/月** · Pro+ $39/月 · Business $19/人 · Max $100/月 | **最便宜入门**;行内补全永久免费;认证师生 & 多数开源维护者免费 | GitHub 团队;最稳妥的企业选择 | [github.com/features/copilot](https://github.com/features/copilot) |
...
| **Claude Code** | 经 Claude Pro **$17/月(年付)–$20/月** · Max $100–$200/月 | 年付约 85 折 | 最强推理;大型重构;1M 上下文 | [claude.com/claude-code](https://www.claude.com/product/claude-code) |
...
| **OpenCode** | 核心免费 · **Go 计划** 付费档(见官网) | 据称 Go 计划有新用户促销 | 多会话、LSP、75+ 模型、低价中文模型 | [opencode.ai](https://opencode.ai) |
...
定价与产品信息汇总自各厂商官方定价页、更新日志及 2026 年权威对比,核实时间为 **2026-06**。每个工具均链接官网(见上)。该领域变化极快,**付费前请务必在官网确认当前价格。**
